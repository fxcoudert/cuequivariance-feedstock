About cuequivariance-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/cuequivariance-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cuequivariance-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cuequivariance
# for installing globally
pixi global install cuequivariance
```
...
It is possible to list all of the versions of `cuequivariance` available on your platform:
...
```
pixi search cuequivariance --channel conda-forge
```
